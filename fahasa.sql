...
--
CREATE DATABASE IF NOT EXISTS `fahasadb2` DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci;
USE `fahasadb2`;
...
CREATE TABLE `product` (
  ...
  `product_finalprice` DECIMAL(19,4) DEFAULT NULL,
  ...
  `discount_label_html` text COLLATE utf8_unicode_ci DEFAULT NULL,
  `episode` text DEFAULT NULL,
  `series_id` int(11) DEFAULT NULL,
  `subscribes` text DEFAULT NULL,
